...
class OffTargetLigandDownloader:
    ...
    def process_csv(self):
        ...
        # Save updated CSV
        output_csv = self.output_dir / "bindingdb_with_ligand_paths.csv"
        ...
        success_rate = (len(df) - source_counts.get('failed', 0)) / len(df) * 100
        logger.info(f"Overall success rate: {success_rate:.1f}%")

if __name__ == "__main__":
    CSV_PATH = "/scratch/yunmin/data/graph/bdb/filtered/bindingdb_Kd_with_pdb_val_saved_pdb.csv"
    OUTPUT_DIR = "/scratch/yunmin/data/graph/lmpnn/bdb_pdb/Kd/off_inputs/ligand_sdf"
